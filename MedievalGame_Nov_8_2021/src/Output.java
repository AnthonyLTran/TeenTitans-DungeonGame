...
public class Output {
    public void writeRooms(Player player){
        ...
        try{
            ...
            fileWriter.println("File format :RoomID,RoomName,Description,Separator,isVisited," +
                    "Navigation,ItemID,PuzzleID,MonsterID,canGoNorth");
            ...
            for (Room room : rooms.values()) {
                ...
                fileWriter.println(room.getCanGoForward());
            }
                ...
                if (!items.isEmpty()) {
                    ...
                    for (Item item : items) {
                        ...
                        if(item.getItemType().compareTo("equippable")==0){
                            ...
                            fileWriter.println(((Usable)item).isConsumed());
                        }
                        fileWriter.println(item.isAvailable());
                        fileWriter.println(item.isUsed());
                    }
                }
            }
        ...
        try{
            ...
            for (Room room : rooms.values()) {
                ...
                if(!puzzle.isSolved()){
                    ...
                    fileWriter.println("----");
                    fileWriter.println(puzzle.getSolvedDescription());
                    fileWriter.println("****");
                    ArrayList<String> requiredItems = puzzle.getRequiredItem();
    ...
    public void writeMonsters(Player player){
        ...
        try{
            ...
            fileWriter.println("MonsterID,MonsterName,MonsterDescription,----,DefeatedDescription,****," +
                    "currentHP,dealDamage,droppedItem,isDefeated");
            ...
            for (Room room : rooms.values()) {
                ...
                if(!monster.isDefeated()){
                    ...
                    fileWriter.println("****");
                    fileWriter.println(monster.getCurrentHP());
                    fileWriter.println(monster.getDealDamage());
                    fileWriter.println(monster.getDroppedItem());
    ...
    public void writePlayer(Player player){
        try{
            ...
            fileWriter.println("File format :PlayerID,PlayerHP,PlayerDealDamage,PLayerInventory," +
                    "RoomID,RoundCount,equippedItems,currentMode,MonsterOldHP");
            ...
            fileWriter.println();
            fileWriter.println(player.currentMode);
            fileWriter.println(player.getMonsterOldHP());
            fileWriter.close();
