...
MedievalGame -  contains most of the inner game logic, player decisions and map information.
...
Player - contains player information, including hp, currentRoom, inventory

Input/Output - uses a FileReader to parse the txt files into game objects
